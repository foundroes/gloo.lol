...
$(document).ready(function () {
  ...
  $('#item-1-gloo').click(function () {
    $('#item-1-gloo').removeClass("old-selected");
    $('#item-1-gloo').children(".item-arrow-grey").hide();
    $('#item-1-gloo').siblings().removeClass("old-selected");
    $('#item-1-gloo').siblings().children(".item-arrow-grey").hide();
    $('.folder-gloo').show();
    $('.folder-gloo').siblings().hide();
    $('.folder-gloo').children().removeClass("selected");
    $('.folder-gloo').children().removeClass("old-selected");
    $('.folder-gloo').children().children(".item-arrow-grey").hide();
    $('.folder-gloo').children().children(".item-arrow-blue").hide();
    $('.folder-gloo').children().children(".item-arrow").show();
  });
  ...
  var container = $('.folder-gloo');
  container.click(function () {
    $('#item-1-gloo').removeClass("selected");
    $('#item-1-gloo').addClass("old-selected");
    $('#item-1-gloo').children(".item-arrow-blue").hide();
    $('#item-1-gloo').children(".item-arrow").hide();
    $('#item-1-gloo').children(".item-arrow-grey").show();
  });

  $('#gloo').dblclick(function () {
  ...
  $('#item-instagram').dblclick(function () {
    window.open('https://lostroes.sell.app');
  });


  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/@foundroes');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.gg/pqaYpfXDHj');
  });

  $('#item-2-sellapp').dblclick(function () {
    window.open('https://lostroes.sell.app');
  });
